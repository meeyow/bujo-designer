    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (isLogin) {
                ...
                // Redirect handled by middleware/auth listener
            ...
            <div className="mt-6">
                ...
                <div className="mt-6 grid grid-cols-2 gap-3">
                    <button
                        ...
                        disabled={loading}
                        className="flex items-center justify-center gap-2 py-2 px-4 border border-gray-300 rounded-md hover:bg-gray-50 transition-colors dark:border-gray-600 dark:hover:bg-gray-700 dark:text-white disabled:opacity-50"
                    >
